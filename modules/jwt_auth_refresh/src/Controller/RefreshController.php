...
class RefreshController extends JwtAuthIssuerController {
   ...
   * @inheritDoc
   */
  public function __construct(JwtGeneratorInterface $auth, JwtRefreshTokensInterface $refreshTokens, AccountSwitcherInterface $accountSwitcher, FloodInterface $flood, JwtTranscoderInterface $jwtTranscoder, RequestStack $requestStack) {
